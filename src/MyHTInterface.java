 ...
 * HashTable interface that takes lowercase String values
 * 
...
public interface MyHTInterface {
	 ...
	 * rehashing process happens, Number of collisions value should be properly
	 * updated. The definition of collision is two different keys map to the
	 * same hash value. Be careful with the situation with over counting. Try to
	 ...
	 * @return frequency value if found. If not found, print out not found message
	 */
